...
class ChannelFragment : BindingFragment<FragmentChannelBinding>() {
    ...
    private val viewModel: ChannelViewModel by activityViewModels() //bind view model to activity
    //
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val channelListViewModel: ChannelListViewModel by viewModels { factory }    //we can pass custom factory to this method
        val channelListHeaderViewModel: ChannelListHeaderViewModel by viewModels()
        //bind these view models to ChannelListHeaderView and ChannelListView
