...
//DialogFragment - internally is fragment which makes it easier to navigate to it with navgraph, inject dependencies easily...
@AndroidEntryPoint
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        return MaterialAlertDialogBuilder(requireContext())
            ...
            .setPositiveButton(R.string.create) { _, _ ->
                viewModel.createChannel(binding.etChannelName.toString())
            }
